...
### 출력 
 ...
 ### 해설
 <p> 리스트.sort() : 본체의 리스트를 정렬하여 변환 </p>
 <p> sorted(정렬할 데이터) : 본체의 리스트는 내버려두고 정렬한 새로운 리스트를 반환</p>
 <p> set() : 집합 자료형, 중복 허용 x / 순서 x  </p>
 <p> .add() : 집합 자료형에 요소를 추가할 때 사용  </p>
 <p> set(A - B) : '-' 집합 자료형 차집합을 구할 때 사용</p>
